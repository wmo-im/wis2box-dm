...
def get_package_version():
    ...
    version_file = read('station_metadata/__init__.py')
...
DESCRIPTION = 'Database schema to manage station metadata'
...
setup(
    ...
    url='https://github.com/wmo-im/station-metadata',
    install_requires=read('requirements.txt').splitlines(),
    packages=find_packages(),
    include_package_data=True,
    entry_points={
        'console_scripts': [
            'station_metadata=station_metadata.cli:cli'
        ]
    },
    classifiers=[
