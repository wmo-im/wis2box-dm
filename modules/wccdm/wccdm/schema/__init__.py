...
from sqlalchemy import (bindparam, create_engine, text, DateTime, event,
...
class Observation(Base):
    ...
    phenomenon_time_end: Mapped[datetime.datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    ...
    __mapper_args__ = {"polymorphic_on": phenomenon_time_end}


#class child1(Observation):
#    __tablename__ = None
#    __mapper_args__ = {"polymorphic_identity": "t20240409"}
